...
export default function App() {
  ...
  // Sync theme state with document element for Tailwind class-based dark mode
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-50 dark:bg-black text-slate-900 dark:text-emerald-400 overflow-x-hidden font-mono transition-colors duration-300">
      ...
      {/* BACKGROUND DITHER LAYER */}
      <div className="fixed inset-0 z-0 w-full h-full pointer-events-none opacity-40 dark:opacity-100">
        <Dither
      ...
      <div className="relative z-10 flex flex-col min-h-screen justify-between">
        ...
        {currentView === "arena" && <QuizArena />}

        {currentView === "landing" && (
          <>
            {/* HERO SECTION */}
            <main className="max-w-7xl mx-auto px-6 py-2 lg:py-20 grid lg:grid-cols-12 gap-12 items-center">
              {/*Add new Dither  */}
                ...
                >
                  <div className="space-y-4 text-left">
                    ...
                    <h1 className="text-4xl sm:text-6xl font-black font-sans tracking-tight leading-tight text-black dark:text-slate-900 uppercase">
                     <span className="text-5xl sm:text-5xl text-black font-sans tracking-tight leading-tight dark:text-slate-200"> DOMINATE NEET THROUGH{" "}</span>
                    ...
                    <div className="flex flex-wrap gap-4 pt-7 font-mono">
                      ...
                      <button className="flex items-center gap-3 px-8 py-4 rounded-xl bg-white dark:bg-zinc-950 text-emerald-700 dark:text-emerald-400 font-bold text-sm border border-slate-300 dark:border-emerald-900/60 uppercase tracking-wider transition-all hover:border-emerald-500 cursor-pointer font-mono">
            ...
            >
              <section className="max-w-7xl mx-auto px-6 py-16 w-full">
                <div className="text-center space-y-3 mb-12">
                  ...
                  <h2 className="text-4xl sm:text-6xl font-black font-sans uppercase text-slate-900 dark:text-white">
